...
class CodeHilite(object):
    ...
    * linenumstyle: (str) 'inline' or 'table' ('table' by default).
    ...
    * hl_lines: (List of integers) Lines to emphasize, 1-indexed.
    ...
    def __init__(self, src=None, linenums=None, linenumstyle='table',
                 guess_lang=True,
        ...
        self.linenumstyle = linenumstyle,
    ...
    def _parseHeader(self):
        ...
        #     \s*                             # Arbitrary whitespace
        #     # Optional linenums setting, single- or double-quote-delimited
        #     (linenums=(?P=quot)(?P<linenums>.*?)(?P=quot))?
        #     ''', re.VERBOSE
        # )
        ...
        for block in blocks:
            if len(block) == 1 and block[0].tag == 'code':
                code = CodeHilite(
                    ...
                    linenumstyle=self.config['linenumstyle'],
